...
const dbId = import.meta.env.VITE_FIREBASE_FIRESTORE_DATABASE_ID || firebaseConfigJson.firestoreDatabaseId || "ai-studio-masdaralriyadh-4b6f2b33-9b09-4263-a852-9ba5f6d8b233";
